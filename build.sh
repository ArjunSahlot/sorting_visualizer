...
&& rm -rf master.zip \
&& mkdir -p $1 \
&& cp -r $temporary_dir/sorting_visualizer-master $1/sorting_visualizer \
&& rm -rf $temporary_dir \
&& echo -e "\033[0;32mSuccessfully downloaded to $1/sorting_visualizer\033[0m" \
